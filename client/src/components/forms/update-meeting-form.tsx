...
import { UpdateFormSchema } from '@/lib/update-event'
...
export function UpdateMeetingForm() {
  ...
  async function onSubmit(data: z.infer<typeof UpdateFormSchema>) {
    ...
    const updatedData = {
      ...
      ...(formatDate && { meeting_date: formatDate }),
      ...(formatTime && { meeting_time: formatTime }),
    }
    await updateMeeting(data.id, updatedData)
